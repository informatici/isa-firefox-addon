...
const APP_PACKAGE = "/informaction/{appname}";
const APP_VERSION = "{appversion}";
const APP_PREFS_FILE="defaults/preferences/pref.js";
const APP_XPCOM_SERVICE=null;
const APP_JAR_FILE = "{appname}.jar";
...
function myPerformInstall(secondTry) {
  ...
  var chromef = instToProfile ? getFolder("Profile", "extensions/{appid}/chrome") : getFolder("chrome");
